...
data HappyAbsSyn 
	...
	| HappyErrorToken Int
	| HappyAbsSyn4 (PExp)
	| HappyAbsSyn5 (PComposition)
	| HappyAbsSyn6 (PContext)
	| HappyAbsSyn8 ((Token,Token))
	| HappyAbsSyn9 (PCtxVal)
...
action_0,
 ...
 action_16,
 action_17,
 action_18 :: () => Int -> ({-HappyReduction (Either String) = -}
	   Int 
	-> (Token)
...
happyReduce_1,
 ...
 happyReduce_7,
 happyReduce_8,
 happyReduce_9 :: () => ({-HappyReduction (Either String) = -}
	   Int 
	-> (Token)
	-> HappyState (Token) (HappyStk HappyAbsSyn -> [(Token)] -> (Either String) HappyAbsSyn)
	-> [HappyState (Token) (HappyStk HappyAbsSyn -> [(Token)] -> (Either String) HappyAbsSyn)] 
...
happyExpList = Happy_Data_Array.listArray (0,33) ([1024,16384,0,532,32,0,0,0,0,0,16384,0,0,1056,0,32768,8192,0,0,1024,0,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_buildAST","Exp","PComposition","PContext","CtxAssignments","CtxAssignment","PCtxVal","num","note","chord","'{'","'}'","ctxWord","'='","','","'.'","';'","%eof"]
        bit_start = st * 20
        bit_end = (st + 1) * 20
...
action_13 (9) = happyGoto action_17
...
happyReduction_2 (HappyTerminal happy_var_2)
	(HappyTerminal happy_var_1)
	 =  HappyAbsSyn5
		 (PNoteN happy_var_1 happy_var_2
	)
...
happyReduction_4 (HappyAbsSyn5  happy_var_2)
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn5
		 (PConcatted happy_var_1 happy_var_2
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	T _ TNum _ -> cont 10;
	T _ TNote _ -> cont 11;
	T _ TChord _ -> cont 12;
	T _ TOBracket _ -> cont 13;
	T _ TCBracket _ -> cont 14;
	T _ TCtxLabel _ -> cont 15;
	T _ TEq _ -> cont 16;
	T _ TComma _ -> cont 17;
	T _ TDot _ -> cont 18;
	T _ TSemi _ -> cont 19;
	_ -> happyError' ((tk:tks), [])
	}
...
buildAST tks = happySomeParser where
...
{-# LINE 7 "<command-line>" #-}
{-# LINE 1 "/home/dawit/.stack/programs/x86_64-linux/ghc-8.6.5/lib/ghc-8.6.5/include/ghcversion.h" #-}
